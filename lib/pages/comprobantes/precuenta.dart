...
import '../imprimir/imprimir.dart';

class Precuenta extends StatefulWidget {
  final Map data;
  const Precuenta(this.data,{super.key});
  @override
  State<Precuenta> createState() => _PrecuentaState();
}

class _PrecuentaState extends State<Precuenta> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                WidgetsToImage(
                  controller: _wti,
                  child: PrintableDocPrecuenta(_data),
                ),
              ],
            ),
          ),
