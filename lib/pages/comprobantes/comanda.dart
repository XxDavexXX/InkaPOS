...
import '../../widgets/printable_doc_comanda_enviar.dart';
...
class Comanda extends StatefulWidget {
  final Map data;
  const Comanda(this.data, {super.key});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          sep,
          MyIcon(Icons.arrow_back, () => Navigator.pop(context)),
          sep,
        ],
      ),
      body: SizedBox(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                WidgetsToImage(
                  controller: _wti,
                  child: PrintableDocComanda(_data),
                ),
              ],
            ),
          ),
