...
class _DashboardState extends State<Dashboard> with RouteAware {
  ...
  void didChangeDependencies() {
    ...
    _loadTurno(); // aún puedes mantener esto si deseas cargar al entrar por primera vez
  }
  ...
  @override
  void didPopNext() {
    // Se ejecuta cuando regresas a este widget desde otra pantalla
    _loadTurno(); // recarga el turno desde Hive
  }

  Future<void> _loadTurno() async {
    final turnoActual = getTurnoActual();
    setState(() {
      _turno = turnoActual;
    });
  }
  ...
  void _download() async {
    int? index = await choose(context, [
      'Descarga de datos',
      'Enviar datos',
    ...
    List<Map> list = [
      {
        'id': 111,
        'nombre': 'Agua sin gas',
        'nombreCorto': 'Agua sin gas',
        'precioUnit': 5.00,
        'precioDelivery': 5.00,
        'precioVentanilla': 5.00,
        'observaciones': ['500 ml', '750 ml', '1 litro'],
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
        'flexible': false,
        'igv': 10.0,
        'cantidad': 1,
      ...
      },
      {
        ...
        'nombreCorto': 'Coca cola zero',
        'precioUnit': 6.00,
        'precioDelivery': 6.00,
        'precioVentanilla': 6.00,
        'observaciones': ['500 ml', '750 ml', '1 litro'],
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
      ...
      {
        'id': 444,
        'nombre': 'Inka Cola zero',
        'nombreCorto': 'Inka Cola zero',
        'precioUnit': 6.00,
        'precioDelivery': 6.00,
        'precioVentanilla': 6.00,
        'observaciones': ['500 ml', '750 ml', '1 litro'],
      ...
      },
      {
        ...
        'precioUnit': 16.00,
        'precioDelivery': 16.00,
        'precioVentanilla': 16.00,
        'observaciones': ['Bien cocido', 'Termino medio', 'Poco cocido'],
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
      ...
      {
        'id': 666,
        'nombre': 'Chaufa con sillao',
        'nombreCorto': 'Chaufa con sillao',
        'precioUnit': 36.0,
        'precioDelivery': 36.0,
        'precioVentanilla': 36.0,
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
      ...
      {
        'id': 777,
        'nombre': 'Helado lúcuma',
        'nombreCorto': 'Helado lúcuma',
        'precioUnit': 17.0,
        'precioDelivery': 17.0,
        'precioVentanilla': 17.0,
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
      ...
      },
      {
        ...
        'nombreCorto': 'Helado chocolate',
        'precioUnit': 16.0,
        'precioDelivery': 16.0,
        'precioVentanilla': 16.0,
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
      ...
      },
      {
        ...
        'nombreCorto': 'Helado Vainilla',
        'precioUnit': 15.0,
        'precioDelivery': 15.0,
        'precioVentanilla': 15.0,
        'codigoDeBarras': '1234',
        'grupo': 'Tickets',
        'subgrupo': 'Cervezas y complementos',
        'combo': true,
  ...
  Future<void> _fetchCajas() async {
    ...
    final activa = box.values.firstWhere(
      (e) => e['activa'] == true,
      orElse: () => {},
    );
    if (activa.isNotEmpty) {
      await setCajaActual(activa);
    } else {
      await setCajaActual(null); // o puedes mostrar una alerta si prefieres
    }
  }
    ...
    List<Map> list = [
      {
        ...
        'nombre': 'Manuel Gomez',
        'documento': 'DNI',
        'nroDeDocumento': '64826459',
        'direccion': 'Address 123',
        'correo': 'manu23g@hotmail.com',
        'telefono': '9993472446',
      },
      {
        'id': 222,
        ...
        'documento': 'DNI',
        'nroDeDocumento': '5657674',
        'direccion': 'San Borja 72',
        'correo': 'fernanda.s@gmail.com',
        'telefono': '9992039447',
      },
      {
        'id': 333,
        'nombre': 'Mauricio Aramburu',
        'documento': 'DNI',
        'nroDeDocumento': '64826459',
        'direccion': 'La victoria 36',
        'correo': 'mauricio.@gmail.com',
        'telefono': '999476548',
      },
    ];
    for (int i = 0; i < list.length; i++) {
      await addClient(list[i]);
    }
  }
    ...
    switch (opts[opt!]) {
      ...
      case 'Acerca de':
        await dialog(
          ...
          children: [
            ...
            P(
              '@Copyright 2020 TrinetSoft S.A.C.',
              color: Colors.black,
              align: P.center,
              overflow: TextOverflow.clip,
              size: 12,
            ...
            P(
              'TrinetPOS es una marca registrada por TrinetSoft S.A.C.',
              color: Colors.black,
              align: P.center,
              overflow: TextOverflow.clip,
              size: 12,
            ...
            sep,
            P(
              'Indecopi - Nro de partida registral:',
              color: Colors.black,
              align: P.center,
              overflow: TextOverflow.clip,
              size: 12,
      ...
      case 'Test base de datos':
        ...
        alert(
          ...
          isDbOk
              ? 'Conexión correcta'
              : 'Hubo errores al testear la conexión a la base datos',
        );
        break;
      case 'Soporte':
        launchUrl(
          Uri.parse('https://api.whatsapp.com/send/?phone=51934564288'),
        );
        break;
    }
  }
  ...
  void _aFacturar() async {
    ...
    if (turno?['usuarioID'] != user?['id']) {
      await alert(
        context,
        'Solo el usuario que abrió el turno puede operar esta caja.\nTurno abierto por otro usuario.',
      );
      return;
    }
  ...
  void _testing() async {
    ...
    switch (opts[opt!]) {
      case 'Limpiar carrito':
        ...
        break;
      case 'Eliminar registros de venta':
        (() async {
          if ((await confirm(context, 'Eliminar registros de venta')) != true)
            return;
          loadThis(context, () async {
        ...
        break;
      case 'Limpiar correlativos':
        (() async {
          if ((await confirm(
                context,
                '¿Deseas reiniciar todos los correlativos a cero?',
              )) !=
              true)
            return;
  ...
  Widget build(BuildContext context) {
    final turno = _turno;
    final fechaApertura = turno?['fechaApertura'];
    return Scaffold(
                ...
                children: [
                  if (turno != null)
                    Padding(
                      ...
                      child: P(
                        'Turno abierto por: ${getUser()?['usuario'] ?? 'Usuario desconocido'}',
                        size: 14,
                        color: Colors.white,
                        align: P.center,
                      ),
                  ...
                  if (fechaApertura != null)
                    Padding(
                      padding: const EdgeInsets.only(bottom: 8),
                      child: P(
                        'Abierto desde: ${getDateString(DateTime.parse(fechaApertura).millisecondsSinceEpoch, 'day/month/year hour:minute')}',
                        size: 14,
                        color: Colors.white,
                        align: P.center,
                      ),
                  ...
                  MyButton(
                    Icons.edit_document,
                    'MAESTROS',
                    () => goTo(context, const Maestros()),
                    isGrey: true,
                  ),
                  // MyButton(
                  //   Icons.lock,
                  //   'CERRAR TURNO',
                  //   () => goTo(context, const CierreDeTurno()),
                  // ),
                  MyButton(Icons.lock, 'CERRAR TURNO', () async {
                    final result = await goTo(context, const CierreDeTurno());
                    if (result == true) {
                      await _loadTurno();
                    }
                  }),
      ...
      child: SizedBox(
        ...
        child: Button(
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, color: isGrey ? Colors.white : Colors.black),
              sep,
              P(
                text,
