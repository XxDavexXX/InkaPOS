...
class ReporteTurnoZ extends StatefulWidget {
  const ReporteTurnoZ({super.key});
  @override
  State<ReporteTurnoZ> createState() => _ReporteTurnoZState();
}

class _ReporteTurnoZState extends State<ReporteTurnoZ> {
